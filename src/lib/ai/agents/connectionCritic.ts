    ...
    messages: [
      {
        ...
        content:
          ...
          'مو مرفوض. مثال رابط ناجح لازم يُقبل: "Ronaldo #7" لمعلومة رقمها 7 — رونالدو فعلًا رقمه 7، ' +
          'هذه حقيقة صحيحة، القبول هنا صحيح رغم إنه يحتاج معرفة رونالدو. مثال رابط يُرفض صح: تشابه ' +
          'الحروف بين "anechoic" و"رون" بدون أي حقيقة موثقة تربطهما. ' +
