    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-8 pt-20 text-center md:pt-28">
          ...
          <h1 className="animate-fade-up text-balance text-5xl font-extrabold leading-[1.05] tracking-tight text-ink-900 md:text-7xl">
            اربطها بطريقة
            <br />
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/register"
              className="rounded-full bg-accent-500 px-8 py-3.5 text-base font-bold text-white shadow-glow transition hover:bg-accent-600"
            >
              ابدأ مجانًا
            </Link>
            <a
              href="#demo"
              className="rounded-full border border-ink-200 bg-surface px-8 py-3.5 text-base font-bold text-ink-800 transition hover:border-ink-300"
            >
              جرّب مثال
            </a>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            {
              emoji: '📈',
              title: 'يتطوّر وياك أول بأول',
              body: 'كل ❤️ و👎 و🔄 يعلّمنا أكثر عن طريقتك المفضلة بالحفظ.'
            }
          ].map((f) => (
            <TiltCard key={f.title} maxTilt={6}>
              <div className="rounded-xl2 border border-ink-100 bg-surface p-6 shadow-card transition hover:border-ink-200">
